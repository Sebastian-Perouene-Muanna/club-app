...
export default function Home() {
  const noticias = [
    { titulo: "¡Victoria en casa!", descripcion: "El Club Atlético Lamarque ganó 3-1 contra Deportivo Beltrán.", disciplina: "Fútbol", imagen: "/clublamarque/notihome/noti1.png"    },
    { titulo: "¡Vóley femenino invicto!", descripcion: "Gran desempeño del equipo Sub-16 en la liga regional.", disciplina: "Vóley", imagen: "/clublamarque/notihome/noti2.png" },
    { titulo: "Nuevo equipo de básquet juvenil", descripcion: "Presentación oficial del plantel Sub-18 de básquet.", disciplina: "Básquet", imagen: "/clublamarque/notihome/noti3.png" },
    { titulo: "Obras en la sede social", descripcion: "Se iniciaron mejoras edilicias para optimizar espacios de entrenamiento.", disciplina: "Institucional", imagen: "/clublamarque/notihome/noti4.png" },
  ];
